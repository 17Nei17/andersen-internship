...
class Customer {
  ...
  viewCustomer() {
    console.log(
      `${this.surname},${this.name},${this.midname},${this.adress}, ${this.numberCard}, ${this.numberBankAcc}`
    );
  }
}
...
const customer2 = new Customer('Пунтус', 'Руслан', 'Леонидович', 'город Мозырь', 210, 985743);
const customer3 = new Customer('Блоцкая', 'Дарья', 'Степановна', 'город Мозырь', 295, 547263);
const arrCustomers = [customer1, customer2, customer3];

arrCustomers.sort(function(a, b) {
